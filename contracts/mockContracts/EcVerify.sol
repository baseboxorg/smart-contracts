...
contract ECVerifyContract {
    ...
    function safer_ecrecover(bytes32 hash, uint8 v, bytes32 r, bytes32 s) public view returns (bool, address) {
    ...
    function ecverify(bytes32 hash, bytes sig, address signer) public view returns (bool) {
        bool ret;
        address addr;
...
//    function test_v0() pure returns (bool) {
...
//    }
//
//    function test_v1() pure returns (bool) {
//        bytes32 hash = 0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad;
